                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td className="product-image-title">
                                                            <a href="/product" className="image"><img src="../../public/images/product/default/home-1/default-1.jpg" alt="Compare Product" /></a>
                                                            <a href="shop-grid-sidebar-left.html" className="category">Furniture</a>
                                                            <a href="/product" className="title">Rinosin title</a>
                                                        </td>
                                                        <td className="product-image-title">
                                                            <a href="/product" className="image"><img src="../../public/images/product/default/home-1/default-2.jpg" alt="Compare Product" /></a>
                                                            <a href="shop-grid-sidebar-left.html" className="category">Furniture</a>
                                                            <a href="/product" className="title">Macro title</a>
                                                        </td>
                                                        <td className="product-image-title">
                                                            <a href="/product" className="image"><img src="../../public/images/product/default/home-1/default-3.jpg" alt="Compare Product" /></a>
                                                            <a href="shop-grid-sidebar-left.html" className="category">Furniture</a>
