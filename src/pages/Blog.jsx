                                ...
                                <div className="row mb-n6">
                                        ...
                                        <div className="blog-list blog-grid-single-item blog-color--golden"  data-aos="fade-up"  data-aos-delay="0">
                                            <div className="image-box">
                                                <a href="blog-single-sidebar-left.html" className="image-link">
                                                    <img className="img-fluid" src="../../public/images/blog/blog-grid-home-1-img-1.jpg" alt=""  />
                                                </a>
                                            </div>
                                            ...
                                            <div className="blog-list-slider-arrow">
                                                <div className="blog-list-slider swiper-container">
                                                    <div className="swiper-wrapper">
                                                        <div className="blog-list-slider-img swiper-slide"><img className="img-fluid"  src="../../public/images/blog/blog-grid-home-1-img-4.jpg" alt="" /></div>
                                                        <div className="blog-list-slider-img swiper-slide"><img className="img-fluid"  src="../../public/images/blog/blog-grid-home-1-img-2.jpg" alt="" /></div>
                                                        <div className="blog-list-slider-img swiper-slide"><img className="img-fluid"  src="../../public/images/blog/blog-grid-home-1-img-3.jpg" alt="" /></div>
                                                        <div className="blog-list-slider-img swiper-slide"><img className="img-fluid"  src="../../public/images/blog/blog-grid-home-1-img-1.jpg" alt="" /></div>
                                                        <div className="blog-list-slider-img swiper-slide"><img className="img-fluid"  src="../../public/images/blog/blog-grid-home-1-img-5.jpg" alt="" /></div>
                                                    </div>
                                    ...
                                    <div className="col-md-6 col-12 mb-6">
                                        <div className="blog-list blog-grid-single-item blog-color--golden"  data-aos="fade-up"  data-aos-delay="0">
                                            <div className="blog-video-box">
                                                <img className="img-fluid" src="../../public/images/blog/blog-grid-home-1-img-5.jpg" alt="" />
                                    ...
                                    <div className="col-md-6 col-12 mb-6">
                                        <div className="blog-list blog-grid-single-item blog-color--golden"  data-aos="fade-up"  data-aos-delay="200">
                                            <div className="image-box">
                                                <a href="blog-single-sidebar-left.html" className="image-link">
                                                    <img className="img-fluid" src="../../public/images/blog/blog-grid-home-1-img-2.jpg" alt="" />
                                                </a>
                                            </div>
                                            <div className="content">
                                                <ul className="post-meta">
