                ...
                <div className="col-md-6">
                    <div className="about-img" data-aos="fade-up"  data-aos-delay="0">
                        <div className="img-responsive">
                            <img src="../../public/images/about/img-about.jpg" alt="" />
                        </div>
                    </div>
                </div>
                <div className="col-md-6">
            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-3 col-sm-6 col-12">
                        ...
                        <div className="image">
                                <img src="../../public/images/icons/icon_about1.jpg" alt="" />
                        </div>
                    ...
                    <div className="col-lg-3 col-sm-6 col-12">
                        ...
                        <div className="image">
                                <img src="../../public/images/icons/icon_about2.jpg" alt="" />
                        </div>
                            <div className="content">
                    ...
                    <div className="col-lg-3 col-sm-6 col-12">
                        ...
                        <div className="image">
                                <img src="../../public/images/icons/icon_about3.jpg" alt="" />
                        </div>
                            <div className="content">
                    ...
                    <div className="col-lg-3 col-sm-6 col-12">
                        ...
                        <div className="image">
                                <img src="../../public/images/icons/icon_about4.jpg" alt="" />
                        </div>
                            <div className="content">
                ...
                <div className="row mb-n6">
                    <div className="col-xl-3 mb-5">
                        <div className="team-single" data-aos="fade-up"  data-aos-delay="0">
                            <div className="team-img">
                                <img className="img-fluid" src="../../public/images/team/leader1.png" alt="" />
                            </div>
                    ...
                    <div className="col-xl-3 mb-5">
                        <div className="team-single" data-aos="fade-up"  data-aos-delay="200">
                            <div className="team-img">
                                <img className="img-fluid" src="../../public/images/team/leader2.png" alt="" />
                            </div>
                            <div className="team-content">
                    ...
                    <div className="col-xl-3 mb-5">
                        <div className="team-single" data-aos="fade-up"  data-aos-delay="400">
                            <div className="team-img">
                                <img className="img-fluid" src="../../public/images/team/leader3.png" alt="" />
                            </div>
                            <div className="team-content">
                                <h6 className="team-name font--bold mt-5">Missa Santos</h6>
                    ...
                    <div className="col-xl-3 mb-5">
                        <div className="team-single" data-aos="fade-up"  data-aos-delay="600">
                            <div className="team-img">
                                <img className="img-fluid" src="../../public/images/team/leader4.png" alt="" />
                            </div>
                            <div className="team-content">
                            ...
                            <div className="swiper-container company-logo-slider">
                                <div className="swiper-wrapper">
                                    <div className="company-logo-single-item swiper-slide">
                                        <div className="image"><img  className="img-fluid" src="../../public/images/company-logo/company-logo-1.png" alt="" /></div>
                                    </div>
                                    <div className="company-logo-single-item swiper-slide">
                                        <div className="image"><img className="img-fluid" src="../../public/images/company-logo/company-logo-2.png" alt="" /></div>
                                    </div>
                                    <div className="company-logo-single-item swiper-slide">
                                        <div className="image"><img className="img-fluid" src="../../public/images/company-logo/company-logo-3.png" alt="" /></div>
                                    </div>
                                    <div className="company-logo-single-item swiper-slide">
                                        <div className="image"><img className="img-fluid" src="../../public/images/company-logo/company-logo-4.png" alt="" /></div>
                                    </div>
                                    <div className="company-logo-single-item swiper-slide">
                                        <div className="image"><img className="img-fluid" src="../../public/images/company-logo/company-logo-5.png" alt="" /></div>
                                    </div>
                                    <div className="company-logo-single-item swiper-slide">
                                        <div className="image"><img className="img-fluid" src="../../public/images/company-logo/company-logo-6.png" alt="" /></div>
                                    </div>
                                    <div className="company-logo-single-item swiper-slide">
                                        <div className="image"><img className="img-fluid" src="../../public/images/company-logo/company-logo-7.png" alt="" /></div>
                                    </div>
                                    <div className="company-logo-single-item swiper-slide">
                                        <div className="image"><img className="img-fluid" src="../../public/images/company-logo/company-logo-8.png" alt="" /></div>
                                    </div>
                                </div>
                            </div>
