                ...
                <div className="row mb-n6">
                    ...
                    <div className="col-lg-6 col-12 mb-6">
                        <div className="banner-single-item banner-style-1 banner-animation img-responsive" data-aos="fade-up"  data-aos-delay="0">
                            <div className="image">
                                <img src="./public/images/banner/banner-style-1-img-1.jpg" alt="" />
                            </div>
                            <div className="content">
                        ...
                        <div className="row mb-n6">
                            <div className="col-lg-6 col-sm-6 mb-6">
                                <div className="banner-single-item banner-style-2 banner-animation img-responsive" data-aos="fade-up"  data-aos-delay="0">
                                    <div className="image">
                                        <img src="./public/images/banner/banner-style-2-img-1.jpg" alt="" />
                                    </div>
                                    <div className="content">
                            ...
                            <div className="col-lg-6 col-sm-6 mb-6">
                                <div className="banner-single-item banner-style-2 banner-animation img-responsive" data-aos="fade-up"  data-aos-delay="200">
                                    <div className="image">
                                        <img src="./public/images/banner/banner-style-2-img-2.jpg" alt="" />
                                    </div>
                                    <div className="content">
                            ...
                            <div className="col-lg-6 col-sm-6 mb-6">
                                <div className="banner-single-item banner-style-2 banner-animation img-responsive" data-aos="fade-up"  data-aos-delay="0">
                                    <div className="image">
                                        <img src="./public/images/banner/banner-style-2-img-3.jpg" alt="" />
                                    </div>
                                    <div className="content">
                            ...
                            <div className="col-lg-6 col-sm-6 mb-6">
                                <div className="banner-single-item banner-style-2 banner-animation img-responsive" data-aos="fade-up"  data-aos-delay="200">
                                    <div className="image">
                                        <img src="./public/images/banner/banner-style-2-img-4.jpg" alt="" />
                                    </div>
                                    <div className="content">
                                        <h4>Interior <br /> 
                                            lighting</h4>
            ...
            <div className="row">
                <div className="col-xl-8 offset-xl-2">
                    <div className="banner-single-item banner-style-3 banner-animation img-responsive" data-aos="fade-up"  data-aos-delay="0">
                        <div className="image">
                            <img className="img-fluid" src="./public/images/banner/banner-style-3-img-1.jpg" alt="" />
                        </div>
                        <div className="content">
   ...
   <div className="banner-section">
        <div className="banner-wrapper clearfix">
            <div className="banner-single-item banner-style-4 banner-animation banner-color--golden float-left img-responsive" data-aos="fade-up"  data-aos-delay="0">
                <div className="image">
                    <img className="img-fluid" src="./public/images/banner/banner-style-4-img-1.jpg" alt="" />
                </div>
            ...
            <div className="banner-single-item banner-style-4 banner-animation banner-color--golden float-left img-responsive" data-aos="fade-up"  data-aos-delay="200">
                <div className="image">
                    <img className="img-fluid" src="./public/images/banner/banner-style-4-img-2.jpg" alt="" />
                </div>
                <a href="product-details-default.html" className="content">
                    <div className="inner">
            ...
            <div className="banner-single-item banner-style-4 banner-animation banner-color--golden float-left img-responsive" data-aos="fade-up"  data-aos-delay="400">
                <div className="image">
                    <img className="img-fluid" src="./public/images/banner/banner-style-4-img-3.jpg" alt="" />
                </div>
                <a href="product-details-default.html" className="content">
                    <div className="inner">
            ...
            <div className="banner-single-item banner-style-4 banner-animation banner-color--golden float-left img-responsive" data-aos="fade-up"  data-aos-delay="600">
                <div className="image">
                    <img className="img-fluid" src="./public/images/banner/banner-style-4-img-4.jpg" alt="" />
                </div>
                <a href="product-details-default.html" className="content">
                    <div className="inner">
                    ...
                    <div className="col-12">
                        <div className="instagram-box">
                            <div id="instagramFeed" className="instagram-grid clearfix">
                                <a href="https://www.instagram.com/p/CCFOZKDDS6S/" target="_blank" className="instagram-image-link float-left banner-animation"><img src="./public/images/instagram/instagram-1.jpg" alt="" /></a>
                                <a href="https://www.instagram.com/p/CCFOYDNjWF5/" target="_blank" className="instagram-image-link float-left banner-animation"><img src="./public/images/instagram/instagram-2.jpg" alt="" /></a>
                                <a href="https://www.instagram.com/p/CCFOXH6D-zQ/" target="_blank" className="instagram-image-link float-left banner-animation"><img src="./public/images/instagram/instagram-3.jpg" alt="" /></a>
                                <a href="https://www.instagram.com/p/CCFOVcrDDOo/" target="_blank" className="instagram-image-link float-left banner-animation"><img src="./public/images/instagram/instagram-4.jpg" alt="" /></a>
                                <a href="https://www.instagram.com/p/CCFOUajjABP/" target="_blank" className="instagram-image-link float-left banner-animation"><img src="./public/images/instagram/instagram-5.jpg" alt="" /></a>
                                <a href="https://www.instagram.com/p/CCFOS2MDmjj/" target="_blank" className="instagram-image-link float-left banner-animation"><img src="./public/images/instagram/instagram-6.jpg" alt="" /></a>
                            </div>
